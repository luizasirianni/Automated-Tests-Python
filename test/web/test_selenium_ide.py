...
class TestConsultarBelt():
    ...
    @pytest.mark.parametrize('id, termo, produto, preco, xpathText, xpathPrice',[
        ('1','belt', 'Belt', '$37.14', '//*[@id="product-17"]/div[2]/h1', '//*[@id="product-17"]/div[2]/p/span/bdi'),
        ('2','album', 'Album', '$15.00', '//*[@id="product-24"]/div[2]/h1', '//*[@id="product-24"]/div[2]/p/span/bdi'),
        ('3','beanie', 'Beanie', '$18.00', '//*[@id="main"]/ul/li[2]/a[1]/h2','//*[@id="main"]/ul/li[2]/a[1]/span[2]/ins/span/bdi')
    ])
    def test_consultar_produto_Enter(self, id, termo, produto, preco, xpathText, xpathPrice):
        pasta_prints = 'D:/python/Automated-Tests-Python/test/prints/'
        self.driver.get('http://demostore.supersqa.com/')
        self.driver.get_screenshot_as_file(f'{pasta_prints}teste-{id}-homepage.png')
        ...
        self.driver.get_screenshot_as_file(f'{pasta_prints}teste-{id}-campodepesquisa.png')
